...
map('n', '<leader>msy', searchCopyMultiLine, { desc = "Search and yank on multiple lines"})
map('v', '<leader>msy', searchCopyMultiLineInSelection, { desc = "Search and yank on multiple lines (selection)"})
