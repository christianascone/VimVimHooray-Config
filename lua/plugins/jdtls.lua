            ...
            callback = function()
              ...
              local config = {
                ...
                cmd = {
                  ...
                  "-javaagent:/Applications/LSPs/lombok.jar",
                  ...
                  "-jar",
                  vim.fn.glob(
                    "/Applications/LSPs/jdt-language-server-latest/plugins/org.eclipse.equinox.launcher_1.6.500.v20230717-2134.jar"
                  ),
                  -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^                                       ^^^^^^^^^^^^^^
                  ...
                  "-configuration",
                  "/Applications/LSPs/jdt-language-server-latest/config_mac",
                  -- ^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^        ^^^^^^
